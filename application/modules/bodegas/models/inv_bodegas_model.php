...
class inv_bodegas_model extends CI_Model
{
    ...
    function getArticulosPorBodega($bod_id,$tipo)
    {
        $sql = "CALL s_sp_inv_articulos_x_bodega(?,?)";
        $param = array($bod_id,$tipo);
    ...
    function inserta_bodega($datos){

        $this->db->insert($this->tabla,$datos);
        return true;
    }
    /*articlos*/
    function inserta_articulos($data){

        $this->db->insert($this->tabla_art,$data);
        return true;
    }
