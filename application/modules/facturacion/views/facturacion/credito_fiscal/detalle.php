        ...
        <div class="box">
            <div class="title">
                <h4>
                    ...
                    <span>Detalle credito fiscal</span>
                </h4>
            </div>
            ...
            <div class="content">
                ...
                <div class="span12" style="margin: 0">
                    <table cellpadding="0" cellspacing="0" border="0" class="responsive display table table-bordered sinformato " id="listaArticulosFacturaSelected">
                        ...
                        foreach($items_factura as $row)
                        {
                            ...
                            <td class="span1">'.$row->dcf_cantidad.'</td>
                            <td class="span3"></td>
                            <td class="span3">'.$row->dcf_precio.'</td>
                            <td>'.$row->dcf_monto.'</td>
                        </tr>';
                            echo $html;
                        }
                ...
                <div class="span12" style="margin: 0">
                    <div class="span3 right" style="float: right !important;">
                        <label class="span4 left strong alignR">Sumas $:</label><input type="text" class="right span8" id="efa_subtotal" name="efa_subtotal" readonly value="<?= $factura[0]->ecf_subtotal?>" style="float: right">
                    </div>
                </div>
<div class="span12" style="margin: 0">
                    <div class="span3 right" style="float: right !important;">
                        <label class="span4 left strong alignR">Iva $:</label><input type="text" class="right span8" id="efa_total_iva" name="efa_total_iva" readonly value="<?= $factura[0]->ecf_iva?>" style="float: right">
                    </div>
                </div>
<div class="span12" style="margin: 0">
                    <div class="span3 right" style="float: right !important;">
                        <label class="span4 left strong alignR">Total $:</label><input type="text" class="right span8" id="efa_total" name="efa_total" readonly value="<?= $factura[0]->ecf_total?>" style="float: right">
                    </div>
                </div>
                </div>
            </div>
