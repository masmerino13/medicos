        ...
        <div class="box">
            <div class="title">
                <h4>
                    ...
                    <span>Nuevo credito fiscal</span>
                </h4>
            </div>
            ...
            <div class="content">
                ...
                echo form_open('facturacion/facturar/inserta_encabezado_credito_fiscal',$attributes)
                ?>
                ...
                <div class="span6">
                    ...
                    <div class="form-field-box odd">
                        <div class="row-fluid">
                            ...
                            <input class="span8 validate[required,ajax[validaCodigoFactura]]" id="correlativo" name="correlativo" type="text" value="<?=$codigo_credito?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-field-box odd">
                        <div class="row-fluid">
                            ...
                            <input class="span8" readonly id="bodega" name="bodega" type="text" />
                ...
                <div class="span12" style="margin: 0">
                    <div class="span3 right" style="float: right !important;">
                        <label class="span4 left strong alignR">Sumas $:</label><input type="text" class="right span8" id="sumas" name="sumas" readonly value="<?= @$cotizacion[0]->ect_sumas?>" style="float: right">
                    </div>
                </div>
<div class="span12" style="margin: 0">
                    <div class="span3 right" style="float: right !important;">
