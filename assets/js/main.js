...
$(document).ready(function() {
    ...
    $('#openDialogPeriodo').click(function(){
        $('#periodo-modal').dialog('open');
        return false;
    });

    $('#openDialogEmpresa').click(function(){
        $('#empresas-modal').dialog('open');
        return false;
    });

    $("#periodo-modal").dialog({
                autoOpen: false,
