...
$(document).ready(function() {
    ...
    $('#getArticulosBodega').on('click',function(){
        ...
        $.post( base_url+"/index.php/facturacion/facturar/articulos_bodega", { bod_id: bodega, tipo_proceso:2 }, function(data){
    ...
    if($('#ect_fecha_documento').length) {
        $("#ect_fecha_documento").datepicker({
